  ...
  <div id="sidebar" class="nav-collapse ">
    ...
    <ul class="sidebar-menu" id="nav-accordion">
      ...
      <li class="sub-menu">
        ...
        <ul class="sub">
          <li><a href="<?= base_url('add_categories'); ?>">Categories</a></li>
          <li><a href="<?= base_url('add_sub_categories'); ?>">Sub-Categories</a></li>
        </ul>
      </li>
      ...
      <li class="sub-menu">
        ...
        <ul class="sub">
        <li><a href="<?= base_url('add_products'); ?>">Products</a></li>
          <li><a href="<?= base_url('display_products'); ?>">Display Products</a></li>
        </ul>
      </li>
      <li class="sub-menu">
        <a href="javascript:;">
        ...
        <ul class="sub">
          <li><a href="<?= base_url('add_option'); ?>">Options</a></li>
          <li><a href="<?= base_url('add_option_groups'); ?>">Option Groups</a></li>
        </ul>
      </li>
      <li class="sub-menu">
        <a href="javascript:;">
        ...
        <ul class="sub">
        <li><a href="<?= base_url('orders_manage'); ?>">Manage Orders</a></li>
        </ul>
      </li>
