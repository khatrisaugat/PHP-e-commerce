...
if(isset($_POST['remove'])){
    // print_r($_POST);
    // die();
    $obj->Delete("cart","cid",array($_POST['removeVal']));
    // echo "<script>window.location.href='".base_url()."cart'</script>";
}
if(isset($_POST['update'])){
    // print_r($_POST);
    $update['quantity']=$_POST['quantity'];
    $update['price']=$update['quantity']*$_POST['price'];
    // die();
    $obj->Update("cart",$update,"cid",array($_POST['updateVal']));
    // echo "<script>window.location.href='".base_url()."cart'</script>";
}
$joinQuery=" JOIN products ON products.pid=cart.pid";
$joinQuery.=" JOIN images ON images.image_id=products.featured_image_id";
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center">
                                                <img src="<?=base_url()?>Admin/img/<?=$c['image_src']?>" class="mr-3" alt="..." width="100">
                                        ...
                                        <td>
                                            <form action="" method="post">
                                                <input type="hidden" name="updateVal" value="<?=$c['cid']?>">
