...
$searchResults=ProductController::getProducts('indexing','LIKE',"%".$searchString."%",'','products.pid');
...
$searchResults=ProductController::getProducts('indexing','LIKE',"%".$searchString."%", $initial_page . ',' . $limit,'products.pid');
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4" style="height: 500px;">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="<?=$baseUrl."/assets/images/".$product['image_src']?>" alt="" width="100%">
                            </div>
