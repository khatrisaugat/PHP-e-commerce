        ...
        <tbody>
            <?php foreach ($users as $key => $user) : ?>
                <tr>
                    ...
                    <td><?= $user['username']; ?></td>
                    <td>
                        <a href="<?php //echo base_url() . 'display_users.php?op=d&id=' . $user['uid']; ?>" onclick="return confirm('Are you Sure?');"><i class="fa fa-trash-o" style="color: red;font-size:20px;"></i></a>
                        <a href="<?php //echo base_url() . 'display_users.php?op=e&id=' . $user['uid']; ?>" onclick="return confirm('Are you Sure?');"><i class="fa fa-pencil-square-o" style="color: blue;font-size:20px;margin-left:5rem;"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
